...
func (*Location) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case location.FieldSlug, location.FieldValue:
...
// GetValue returns the ent.Value that was dynamically selected and assigned to the Location.
// This includes values selected through modifiers, order, etc.
func (l *Location) GetValue(name string) (ent.Value, error) {
